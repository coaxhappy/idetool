...
namespace OpenMcdf.Test
{
    ...
    public class CFSStreamTest
    {
        ...
        public void Test_DELETE_STREAM_1()
        {
            ...
            cf.Save(TestContext.CurrentContext.WorkDirectory + "MultipleStorage_REMOVED_STREAM_1.cfs");
            cf.Close();
        }
        ...
        public void Test_DELETE_STREAM_2()
        {
            ...
            cf.Save(TestContext.CurrentContext.WorkDirectory + "MultipleStorage_REMOVED_STREAM_2.cfs");
